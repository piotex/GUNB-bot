...
def insert_requested_values(driver: WebDriver, data_model:DataModel):
    ...
    #     driver.find_element(By.XPATH, x_path_vals.typ_dokumentu).click()
    #     time.sleep(1)
    if xpath1_model.numer_ewidencyjny_wniosku != "":
        wait_for_element(driver, x_path_vals.numer_ewidencyjny_wniosku, 10)
        driver.find_element(By.XPATH, x_path_vals.numer_ewidencyjny_wniosku).send_keys(xpath1_model.numer_ewidencyjny_wniosku)
        time.sleep(1)
    if xpath1_model.numer_ewidencyjny_decyzji != "":
        wait_for_element(driver, x_path_vals.numer_ewidencyjny_decyzji, 10)
        driver.find_element(By.XPATH, x_path_vals.numer_ewidencyjny_decyzji).send_keys(xpath1_model.numer_ewidencyjny_decyzji)
        time.sleep(1)
    if xpath1_model.data_zlozenia_wniosku_od != "":
        wait_for_element(driver, x_path_vals.data_zlozenia_wniosku_od, 10)
        driver.find_element(By.XPATH, x_path_vals.data_zlozenia_wniosku_od).send_keys(xpath1_model.data_zlozenia_wniosku_od)
        time.sleep(1)
    if xpath1_model.data_zlozenia_wniosku_do != "":
        wait_for_element(driver, x_path_vals.data_zlozenia_wniosku_do, 10)
        driver.find_element(By.XPATH, x_path_vals.data_zlozenia_wniosku_do).send_keys(xpath1_model.data_zlozenia_wniosku_do)
        time.sleep(1)
    if xpath1_model.data_wydania_decyzji_od != "":
        wait_for_element(driver, x_path_vals.data_wydania_decyzji_od, 10)
        driver.find_element(By.XPATH, x_path_vals.data_wydania_decyzji_od).send_keys(xpath1_model.data_wydania_decyzji_od)
        time.sleep(1)
    if xpath1_model.data_wydania_decyzji_do != "":
        wait_for_element(driver, x_path_vals.data_wydania_decyzji_do, 10)
        driver.find_element(By.XPATH, x_path_vals.data_wydania_decyzji_do).send_keys(xpath1_model.data_wydania_decyzji_do)
        time.sleep(1)
    # if xpath1_model.wojewodztwo_1 != "":
    #     wait_for_element(driver, x_path_vals.wojewodztwo_1, 10)
    #     driver.find_element(By.XPATH, x_path_vals.wojewodztwo_1).click()
    #     time.sleep(1)
    # if xpath1_model.organ_administracji != "":
    #     wait_for_element(driver, x_path_vals.organ_administracji, 10)
    #     driver.find_element(By.XPATH, x_path_vals.organ_administracji).click()
    #     time.sleep(1)
    # if xpath1_model.wojewodztwo_2 != "":
    #     wait_for_element(driver, x_path_vals.wojewodztwo_2, 10)
    #     driver.find_element(By.XPATH, x_path_vals.wojewodztwo_2).click()
    #     time.sleep(1)
    ...
    #     driver.find_element(By.XPATH, x_path_vals.rodzaj_zamierzenia_budowlanego).click()
    #     time.sleep(1)
    # if xpath1_model.kategoria_obiektu != "":
    #     wait_for_element(driver, x_path_vals.kategoria_obiektu, 10)
    #     driver.find_element(By.XPATH, x_path_vals.kategoria_obiektu).click()
    #     time.sleep(1)
